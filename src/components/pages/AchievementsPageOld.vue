			...
			<div ref="swiper" class="swiper-container">
				...
				<div class="swiper-wrapper">
					<div 
						...
						:key="index" 
					>
						<div class="swiper-image !bg-gray-800" data-swiper-parallax-y="-20%">
							<div class="swiper-image-inner swiper-image-left" style="background-color: #1f2937;">
								<p class="paragraph">{{ image.text }}</p>
							</div>
						</div>
						<div class="swiper-image" data-swiper-parallax-y="35%">
							<div 
								class="swiper-image-inner swiper-image-right"
...
<script>
import Swiper, {FreeMode, Navigation, Pagination,  Parallax } from 'swiper'
import 'swiper/css'
	...
	data() {
		return {
			...
			images:  [
					{
						id:1, 
						url: 'https://sukharevskiy.vercel.app/images/%D1%81ertificates/SertifikatK.jpg', 
						text:'Прохождение стажировки в Отделе по работе с молодежью в КонсультантПлюс'
					},
					{id:2, url: 'https://sukharevskiy.vercel.app/images/%D1%81ertificates/TIN.jpg'},
					{id:3, url: 'https://sukharevskiy.vercel.app/images/%D1%81ertificates/SertifikatK.jpg'},
					{id:4, url: 'https://sukharevskiy.vercel.app/images/%D1%81ertificates/TIN.jpg'},
				]
			}
	},
	mounted() {
		...
		new Swiper(this.$refs.swiper, {
			...
			modules: [FreeMode, Navigation, Pagination,  Parallax	],
			pagination: {
...
.swiper-image-one {
  background-image: url(https://sukharevskiy.vercel.app/images/%D1%81ertificates/SertifikatK.jpg);
}

.swiper-image-two {
  background-image: url(https://sukharevskiy.vercel.app/images/%D1%81ertificates/TIN.jpg);
}
